...
func QueueListDataSourceSchema(ctx context.Context) schema.Schema {
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"status": schema.SingleNestedAttribute{
							...
							MarkdownDescription: "QueueStatus defines the observed state of Queue",
						},
					},
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	queueIdAttribute, ok := attributes["queue_id"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`queue_id is missing from object`)

		return nil, diags
	}

	queueIdVal, ok := queueIdAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`queue_id expected to be basetypes.Int64Value, was: %T`, queueIdAttribute))
	}

	queueTypeAttribute, ok := attributes["queue_type"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`queue_type is missing from object`)

		return nil, diags
	}

	queueTypeVal, ok := queueTypeAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`queue_type expected to be basetypes.StringValue, was: %T`, queueTypeAttribute))
	}
...
type SpecValue struct {
	QueueId     basetypes.Int64Value  `tfsdk:"queue_id"`
	QueueType   basetypes.StringValue `tfsdk:"queue_type"`
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["queue_id"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["queue_type"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.QueueId.ToTerraformValue(ctx)
		...
		val, err = v.QueueType.ToTerraformValue(ctx)
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		"queue_id":     basetypes.Int64Type{},
		"queue_type":   basetypes.StringType{},
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.QueueId.Equal(other.QueueId) {
		return false
	}

	if !v.QueueType.Equal(other.QueueType) {
		return false
	}
