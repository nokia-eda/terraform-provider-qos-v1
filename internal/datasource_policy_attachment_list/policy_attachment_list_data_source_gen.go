...
package datasource_policy_attachment_list
...
func PolicyAttachmentListDataSourceSchema(ctx context.Context) schema.Schema {
...
type PolicyAttachmentListModel struct {
