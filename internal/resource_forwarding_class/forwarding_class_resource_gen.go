...
package resource_forwarding_class
...
func ForwardingClassResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ForwardingClass$"), ""),
				},
				Default: stringdefault.StaticString("ForwardingClass"),
			},
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ForwardingClassStatus defines the observed state of ForwardingClass",
			},
		},
	}
}

type ForwardingClassModel struct {
