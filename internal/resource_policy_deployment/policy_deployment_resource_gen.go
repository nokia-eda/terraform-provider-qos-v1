...
package resource_policy_deployment
...
func PolicyDeploymentResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^PolicyDeployment$"), ""),
				},
				Default: stringdefault.StaticString("PolicyDeployment"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the PolicyDeployment",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "PolicyDeploymentStatus defines the observed state of PolicyDeployment",
			},
		},
	}
}

type PolicyDeploymentModel struct {
