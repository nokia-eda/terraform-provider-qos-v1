...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-qos/internal/resource_policy_attachment"
	"github.com/nokia/eda/apps/terraform-provider-qos/internal/tfutils"
)

const (
	create_rs_policyAttachment = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/policyattachments"
	read_rs_policyAttachment   = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/policyattachments/{name}"
	update_rs_policyAttachment = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/policyattachments/{name}"
	delete_rs_policyAttachment = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/policyattachments/{name}"
)

var (
	_ resource.Resource                = (*policyAttachmentResource)(nil)
	_ resource.ResourceWithConfigure   = (*policyAttachmentResource)(nil)
	_ resource.ResourceWithImportState = (*policyAttachmentResource)(nil)
)
...
func (r *policyAttachmentResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_policy_attachment.PolicyAttachmentResourceSchema(ctx)
}

func (r *policyAttachmentResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_policy_attachment.PolicyAttachmentModel
	...
	tflog.Info(ctx, "Create()::API request", map[string]any{
		"path": create_rs_policyAttachment,
	...
	err = r.client.Create(ctx, create_rs_policyAttachment, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_policyAttachment, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_policyAttachment,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *policyAttachmentResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	tflog.Info(ctx, "Update()::API request", map[string]any{
		"path": update_rs_policyAttachment,
		"body": spew.Sdump(reqBody),
	})
	...
	err = r.client.Update(ctx, update_rs_policyAttachment, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *policyAttachmentResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	tflog.Info(ctx, "Delete()::API request", map[string]any{
		"path": delete_rs_policyAttachment,
		"data": spew.Sdump(data),
	})
	...
	err := r.client.Delete(ctx, delete_rs_policyAttachment, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
