...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-qos/internal/datasource_policy_attachment"
...
const read_ds_policyAttachment = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/policyattachments/{name}"

var (
	_ datasource.DataSource              = (*policyAttachmentDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*policyAttachmentDataSource)(nil)
)
...
func (d *policyAttachmentDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_policy_attachment.PolicyAttachmentDataSourceSchema(ctx)
}

func (d *policyAttachmentDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_policy_attachment.PolicyAttachmentModel
	...
	err = d.client.GetByQuery(ctx, read_ds_policyAttachment, map[string]string{
...
func (r *policyAttachmentDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
