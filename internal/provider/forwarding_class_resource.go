...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-qos/internal/resource_forwarding_class"
	"github.com/nokia/eda/apps/terraform-provider-qos/internal/tfutils"
)

const (
	create_rs_forwardingClass = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/forwardingclasss"
	read_rs_forwardingClass   = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/forwardingclasss/{name}"
	update_rs_forwardingClass = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/forwardingclasss/{name}"
	delete_rs_forwardingClass = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/forwardingclasss/{name}"
)

var (
	_ resource.Resource                = (*forwardingClassResource)(nil)
	_ resource.ResourceWithConfigure   = (*forwardingClassResource)(nil)
	_ resource.ResourceWithImportState = (*forwardingClassResource)(nil)
)
...
func (r *forwardingClassResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_forwarding_class.ForwardingClassResourceSchema(ctx)
}

func (r *forwardingClassResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_forwarding_class.ForwardingClassModel
	...
	tflog.Info(ctx, "Create()::API request", map[string]any{
		"path": create_rs_forwardingClass,
	...
	err = r.client.Create(ctx, create_rs_forwardingClass, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_forwardingClass, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_forwardingClass,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *forwardingClassResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	tflog.Info(ctx, "Update()::API request", map[string]any{
		"path": update_rs_forwardingClass,
		"body": spew.Sdump(reqBody),
	})
	...
	err = r.client.Update(ctx, update_rs_forwardingClass, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *forwardingClassResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	tflog.Info(ctx, "Delete()::API request", map[string]any{
		"path": delete_rs_forwardingClass,
		"data": spew.Sdump(data),
	})
	...
	err := r.client.Delete(ctx, delete_rs_forwardingClass, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *forwardingClassResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
