...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-qos/internal/datasource_queue"
...
const read_ds_queue = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/queues/{name}"
...
func (d *queueDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_queue, map[string]string{
...
func (r *queueDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
