...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-qos/internal/resource_policy_deployment"
	"github.com/nokia/eda/apps/terraform-provider-qos/internal/tfutils"
)

const (
	create_rs_policyDeployment = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/policydeployments"
	read_rs_policyDeployment   = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/policydeployments/{name}"
	update_rs_policyDeployment = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/policydeployments/{name}"
	delete_rs_policyDeployment = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/policydeployments/{name}"
)

var (
	_ resource.Resource                = (*policyDeploymentResource)(nil)
	_ resource.ResourceWithConfigure   = (*policyDeploymentResource)(nil)
	_ resource.ResourceWithImportState = (*policyDeploymentResource)(nil)
)

func NewPolicyDeploymentResource() resource.Resource {
	return &policyDeploymentResource{}
}
...
func (r *policyDeploymentResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_policy_deployment.PolicyDeploymentResourceSchema(ctx)
}

func (r *policyDeploymentResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_policy_deployment.PolicyDeploymentModel
	...
	tflog.Info(ctx, "Create()::API request", map[string]any{
		"path": create_rs_policyDeployment,
	...
	err = r.client.Create(ctx, create_rs_policyDeployment, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_policyDeployment, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_policyDeployment,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *policyDeploymentResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	tflog.Info(ctx, "Update()::API request", map[string]any{
		"path": update_rs_policyDeployment,
		"body": spew.Sdump(reqBody),
	})
	...
	err = r.client.Update(ctx, update_rs_policyDeployment, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *policyDeploymentResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	tflog.Info(ctx, "Delete()::API request", map[string]any{
		"path": delete_rs_policyDeployment,
		"data": spew.Sdump(data),
	})
	...
	err := r.client.Delete(ctx, delete_rs_policyDeployment, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *policyDeploymentResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *policyDeploymentResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
