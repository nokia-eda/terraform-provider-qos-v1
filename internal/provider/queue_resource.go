...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-qos/internal/resource_queue"
	"github.com/nokia/eda/apps/terraform-provider-qos/internal/tfutils"
)

const (
	create_rs_queue = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/queues"
	read_rs_queue   = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/queues/{name}"
	update_rs_queue = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/queues/{name}"
	delete_rs_queue = "/apps/qos.eda.nokia.com/v1/namespaces/{namespace}/queues/{name}"
)
...
func (r *queueResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_queue, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_queue, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *queueResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_queue, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *queueResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_queue, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
