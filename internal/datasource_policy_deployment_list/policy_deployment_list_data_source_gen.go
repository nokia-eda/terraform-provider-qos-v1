...
package datasource_policy_deployment_list
...
func PolicyDeploymentListDataSourceSchema(ctx context.Context) schema.Schema {
...
type PolicyDeploymentListModel struct {
