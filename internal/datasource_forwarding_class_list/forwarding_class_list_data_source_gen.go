...
package datasource_forwarding_class_list
...
func ForwardingClassListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ForwardingClassListModel struct {
