...
package resource_policy_attachment
...
func PolicyAttachmentResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^PolicyAttachment$"), ""),
				},
				Default: stringdefault.StaticString("PolicyAttachment"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the PolicyAttachment",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "PolicyAttachmentStatus defines the observed state of PolicyAttachment",
			},
		},
	}
}
